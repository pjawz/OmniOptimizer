export async function iterateRanges(user_inputs, optimization_results, index, change_tv_input, sleep, OptimizeParams) {
    ...
    for (let i = start; i <= end; i += step ? step : 0.1) {
        ...
        await iterateRanges(user_inputs, optimization_results, index - 1, change_tv_input, sleep, OptimizeParams);
    }
}
